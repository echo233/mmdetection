...
class CocoDetection(data.Dataset):
    ...
    def __init__(self, root, dataset="train", transforms=None, years="2017"):
        ...
        self.anno_path = "/liu/icme/dataset/train/annotations/instances_train2017.json"
...
# train = CocoDetection("/liu/icme/dataset/", dataset="train",years="")
# print(len(train))
# t = train[0]
# print(t)
...
# }
#
# train_dataset = CocoDetection("/liu/icme/dataset/train", dataset="train", transforms=data_transform["train"], years="")
#
# # load validation data set
# # VOCdevkit -> VOC2012 -> ImageSets -> Main -> val.txt
# #val_dataset = VOCDataSet(VOC_root, "2012", data_transform["val"], "val.txt")
# train_dataset = CocoDetection("/liu/icme/dataset/train", dataset="train", transforms=data_transform["train"], years="")
# val_dataset = CocoDetection("/liu/icme/dataset/train", dataset="val", transforms=data_transform["val"], years="")
#
# train_sampler = torch.utils.data.RandomSampler(train_dataset)
# test_sampler = torch.utils.data.SequentialSampler(val_dataset)
#
# data_loader_train = torch.utils.data.DataLoader(
#     train_dataset, batch_size=2,pin_memory=True,
#     sampler=train_sampler, num_workers=4,
#     collate_fn=train_dataset.collate_fn)
#
# data_loader_test = torch.utils.data.DataLoader(
#     val_dataset, batch_size=2,pin_memory=True,
